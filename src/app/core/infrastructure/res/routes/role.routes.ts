import { getRoles, getRolesActive, getRoleByPk, createRole, updateRole, getRolesByParams } from "../controllers/role.controller";
...
roleRouter.get('/active', [validateToken, getRolesActive])
